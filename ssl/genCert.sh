keytool -genkeypair -keyalg RSA -keysize 2048 -alias front -dname "CN=KOBEFOREVER,OU=Development,O=FRONTNC,C=NL" -ext "SAN:c=DNS:192.168.43.86,IP:192.168.43.86" -validity 3650 -keystore identityOnPN.jks -storepass secret -keypass secret -deststoretype pkcs12
