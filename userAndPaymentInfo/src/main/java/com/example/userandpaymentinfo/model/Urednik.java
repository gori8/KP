...
public class Urednik {
    ...
    @Column(name = "idOblastiKojuUredjujem", nullable = true)
    private Long idOblastiKojuUredjujem;
    ...
    public Long getIdOblastiKojuUredjujem() {
        return idOblastiKojuUredjujem;
    }

    public void setIdOblastiKojuUredjujem(Long idOblastiKojuUredjujem) {
        this.idOblastiKojuUredjujem = idOblastiKojuUredjujem;
    }
