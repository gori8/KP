...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.POST,"/webshop/paypalSubscription/completed/**","/webshop/payed/**","/webshop/payments/complete/**","/webshop/registration/complete/**", "/auth/login","/webshop/registration/**");
