...
public class UrlClass {
    ...
    public static final String SUCCESS_URL_BTC = "https://192.168.43.161:8771/bitcoin/api/bitcoin/payment/success/";
    public static final String CANCEL_URL_BTC = "https://192.168.43.161:8771/bitcoin/api/bitcoin/payment/cancel/";
    public static final String PAYPAL_RETURN_URL = "https://192.168.43.161:8771/paypal/api/paypal/execute" ;
    public static final String PAYPAL_URL = "https://192.168.43.161:8771/paypal/api/paypal/" ;
    public static final String CANCEL_URL_PAYPAL = "https://192.168.43.161:8771/paypal/api/paypal/cancel/" ;
    ...
    public static final String REDIRECT_URL_PAYMENT = "https://localhost:9000/webshop/payed/";
    ...
    //localhost
    /*
    public static final String DOBAVI_CENU_URL_SA_PAYMENT_INFO = "https://localhost:8771/userandpayment/api/amountandurl/";
    public static final String DOBAVI_REDIRECT_URL_SA_BANKE = "https://localhost:8091/payment";
    public static final String SUCCESS_URL_BTC = "https://localhost:8771/bitcoin/api/bitcoin/payment/success/";
    public static final String CANCEL_URL_BTC = "https://localhost:8771/bitcoin/api/bitcoin/payment/cancel/";
    public static final String PAYPAL_RETURN_URL = "https://localhost:8771/paypal/api/paypal/execute" ;
    public static final String CANCEL_URL_PAYPAL = "https://localhost:8771/paypal/api/paypal/cancel/" ;
    public static final String DOBAVI_KP_FRONT_URL_SA_NACINIMA_PLACANJA_FROM_PAYMENT_INFO = "https://localhost:8771/userandpayment/api/url";//NC-DEMO
    public static final String DOBAVI_CASOPIS_NA_NC_DEMO = "https://localhost:9000/nc/casopis/";//NC-DEMO
    public static final String REDIRECT_URL_REGISTRATION = "https://localhost:9000/webshop/payments/complete/";
    public static final String REDIRECT_URL_REGISTRATION_IGOR = "https://localhost:8080/payment/payments/complete/";
